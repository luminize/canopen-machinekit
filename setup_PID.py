...
data=bytearray([0x22, 0x10, 0x32, 0x01, 0x00, 0x20, 0x04, 0x00 ])
send_sdo(data, node)
time.sleep(0.5)

#cansend can0 602#2210320500000000 3210:02 S_I default 0
data=bytearray([0x22, 0x10, 0x32, 0x02, 0x10, 0x00, 0x00, 0x00 ])
send_sdo(data, node)
time.sleep(0.5)
